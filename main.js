...
var AddBookComponent = /** @class */ (function () {
    ...
    AddBookComponent.prototype.addBook = function () {
        ...
        var bookAthorName = this.addBookForm.get("bookName").value;
        var description = this.addBookForm.get("bookDescription").value;
        var datePublish = this.addBookForm.get("bookPublishedDate").value;
        var newBook = new _shared_model_book_model__WEBPACK_IMPORTED_MODULE_2__["Book"](BookID, booktitle, bookAthorName, description, datePublish);
...
/* harmony import */ var _book_details_book_details_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./book-details/book-details.component */ "./src/app/book-details/book-details.component.ts");
/* harmony import */ var _shared_services_books_services__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./shared/services/books.services */ "./src/app/shared/services/books.services.ts");
...
/* harmony import */ var _shared_error_error_component__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./shared/error/error.component */ "./src/app/shared/error/error.component.ts");
/* harmony import */ var _capitalize_only_letters_pipe__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./capitalize-only-letters.pipe */ "./src/app/capitalize-only-letters.pipe.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [
                ...
                _book_details_book_details_component__WEBPACK_IMPORTED_MODULE_11__["BookDetailsComponent"],
                _shared_error_error_component__WEBPACK_IMPORTED_MODULE_16__["ErrorComponent"],
                _capitalize_only_letters_pipe__WEBPACK_IMPORTED_MODULE_17__["CapitalizeOnlyLettersPipe"],
            ],
            imports: [
            ...
            providers: [_shared_services_books_services__WEBPACK_IMPORTED_MODULE_12__["BooksService"], _capitalize_only_letters_pipe__WEBPACK_IMPORTED_MODULE_17__["CapitalizeOnlyLettersPipe"]],
            bootstrap: [_app_component__WEBPACK_IMPORTED_MODULE_2__["AppComponent"]]
        }),
        __metadata("design:paramtypes", [_shared_services_books_services__WEBPACK_IMPORTED_MODULE_12__["BooksService"]])
    ], AppModule);
    return AppModule;
}());
...
module.exports = "\n  <!-- Team member -->\n    <div class=\"image-flip\" ontouchstart=\"this.classList.toggle('hover');\">\n      <div class=\"mainflip\">\n        <div class=\"frontside\">\n          <div class=\"card\">\n            \n            <div class=\"card-body text-center\">\n              <h4 class=\"card-title\">{{book.book_title}}</h4>\n              <h5 class=\"card-title\">{{book.author_name }}</h5>\n              <p class=\"card-text\">{{book.published_date}}</p>\n              <a class=\"btn btn-primary btn-sm\">\n                <i class=\"fa fa-plus\"></i>\n              </a>\n            </div>\n          </div>\n        </div>\n        <div class=\"backside\">\n          <div class=\"card\">\n            <div class=\"card-body text-center mt-4\">\n              <h4 class=\"card-title\">Description</h4>\n              <p class=\"card-text\">{{book.description}}</p>\n              <ul class=\"list-inline\">\n                <button class=\"btn btn-primary\" data-toggle=\"modal\" data-target=\"#editModalCenter\" style=\"font-size:20px\">Edit\n                  <i class=\"fa fa-edit\"></i>\n                </button>\n                &nbsp;\n                <button class=\"btn btn-primary\" data-toggle=\"modal\" data-target=\"#ModalDelete\" style=\"font-size:20px\">Delete\n                  <i class=\"fa fa-trash\"></i>\n                </button>\n              </ul>\n            </div>\n          </div>\n        </div>\n      </div>\n    </div>\n\n\n\n\n<div class=\"modal fade\" id=\"editModalCenter\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"exampleModalCenterTitle\" aria-hidden=\"true\">\n  <div class=\"modal-dialog modal-dialog-centered\" role=\"document\">\n    <div class=\"modal-content\">\n      <div class=\"modal-header\">\n          <label for=\"exampleInputEmail1\">Book Title</label>\n        <input type=\"text\" name=\"book_title\" #book_title=\"ngModel\" class=\"form-control\" aria-describedby=\"emailHelp\" [(ngModel)]=\"book.book_title\">\n        <herolo-error [controlToValidate]=\"editBookForm.controls['bookTitle']\"></herolo-error>\n\n        <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\">\n          <span aria-hidden=\"true\">&times;</span>\n        </button>\n      </div>\n      <div class=\"modal-body\">\n        <form novalidate [formGroup]=\"editBookForm\">\n\n          <label for=\"exampleInputEmail1\">Author Name</label>\n          <input type=\"text\" formControlName=\"bookAutorName\" class=\"form-control\" id=\"title\" value={{book.author_name}}>\n          <herolo-error [controlToValidate]=\"editBookForm.controls['bookAutorName']\"></herolo-error>\n\n\n          <label for=\"exampleInput\">Publish Date</label>\n          <input type=\"date\" class=\"form-control\" formControlName=\"bookPublishedDate\" aria-describedby=\"textHelp\" value={{book.published_date}}>\n          <herolo-error [controlToValidate]=\"editBookForm.controls['bookPublishedDate']\"></herolo-error>\n\n\n          <label for=\"exampleInput\">Description</label>\n          <input type=\"text\" class=\"form-control\" formControlName=\"bookDescription\" aria-describedby=\"textHelp\" value={{book.description}}>\n          <herolo-error [controlToValidate]=\"editBookForm.controls['bookDescription']\"></herolo-error>\n\n        </form>\n      </div>\n\n      <div class=\"modal-footer\">\n          \n        <button type=\"button\" class=\"btn btn-secondary\" data-dismiss=\"modal\">Cancel</button>\n        <button type=\"button\" [disabled]=\"editBookForm.valid\" class=\"btn btn-primary\" (click)=\"updateBook()\">Save changes</button>\n      </div>\n    </div>\n  </div>\n</div>\n\n\n<div class=\"modal fade\" id=\"ModalDelete\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"exampleModalCenterTitle\" aria-hidden=\"true\">\n  <div class=\"modal-dialog modal-dialog-centered\" role=\"document\">\n    <div class=\"modal-content\">\n      <div class=\"modal-header\">\n        <h5>{{book.book_title}}</h5>\n        <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\">\n          <span aria-hidden=\"true\">&times;</span>\n        </button>\n      </div>\n      <div class=\"modal-body\">\n\n        <p>Do you want to delete {{book.author_name}} ?</p>\n\n      </div>\n      <div class=\"modal-footer\">\n        <button type=\"button\" class=\"btn btn-secondary\" data-dismiss=\"modal\">No</button>\n        <button type=\"button\" class=\"btn btn-primary\" (click)=deleteBook(book.id)>Yes</button>\n      </div>\n    </div>\n  </div>\n</div>"
...
var BookDetailsComponent = /** @class */ (function () {
    function BookDetailsComponent(booksService, formBuilder, _booksService) {
        this.booksService = booksService;
        this.formBuilder = formBuilder;
    ...
    BookDetailsComponent.prototype.updateBook = function () {
        this._booksService.updateBook(this.book)
            .subscribe(function () { alert("Updated"); }, function (error) { return alert(error.status + ", " + error.statusText); });
    };
    ...
    BookDetailsComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_shared_services_books_services__WEBPACK_IMPORTED_MODULE_3__["BooksService"],
...
/***/ "./src/app/capitalize-only-letters.pipe.ts":
/*!*************************************************!*\
  !*** ./src/app/capitalize-only-letters.pipe.ts ***!
  \*************************************************/
...
module.exports = "<!-- <div class=\"modal fade\" id=\"exampleModalCenter\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"exampleModalCenterTitle\" aria-hidden=\"true\">\n  <div class=\"modal-dialog modal-dialog-centered\" role=\"document\">\n    <div class=\"modal-content\">\n      <div class=\"modal-header\">\n        <input type=\"text\" class=\"form-control\"  aria-describedby=\"emailHelp\" value={{book.book_title}}>\n        <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\">\n          <span aria-hidden=\"true\">&times;</span>\n        </button>\n      </div>\n      <div class=\"modal-body\">\n        <label for=\"exampleInputEmail1\">Author Name</label>\n        <input type=\"text\" class=\"form-control\" aria-describedby=\"emailHelp\" value={{book.author_name}}>\n\n        <label for=\"exampleInput\">Publish Date</label>\n        <input type=\"date\" class=\"form-control\" aria-describedby=\"textHelp\" value={{book.published_date}}>\n\n        <label for=\"exampleInput\">Description</label>\n        <input type=\"text\" class=\"form-control\" aria-describedby=\"textHelp\" value={{book.description}}>\n\n\n      </div>\n      <div class=\"modal-footer\">\n        <button type=\"button\" class=\"btn btn-secondary\" data-dismiss=\"modal\">Close</button>\n        <button type=\"button\" class=\"btn btn-primary\">Save changes</button>\n      </div>\n    </div>\n  </div>\n</div> -->"
...
var EditBookComponent = /** @class */ (function () {
    ...
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", _shared_model_book_model__WEBPACK_IMPORTED_MODULE_1__["Book"])
    ], EditBookComponent.prototype, "book", void 0);
    EditBookComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'herolo-edit-book',
...
var HomePageComponent = /** @class */ (function () {
    ...
    HomePageComponent.prototype.deleteBookByID = function (bookID) {
        var _this = this;
        this._booksService.deleteBook(bookID)
            .subscribe(function () { alert("Deleted"), _this.router.navigateByUrl(""); }, function (error) { return alert(error.status + ", " + error.statusText); });
    };
...
var Book = /** @class */ (function () {
    ...
    Object.defineProperty(Book, "textValidators", {
        get: function () {
            return [_val__WEBPACK_IMPORTED_MODULE_0__["Val"].required(), _val__WEBPACK_IMPORTED_MODULE_0__["Val"].letters(), _val__WEBPACK_IMPORTED_MODULE_0__["Val"].minLength(5), _val__WEBPACK_IMPORTED_MODULE_0__["Val"].maxLength(25)]; // Default Messages.
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(Book, "descriptionValidators", {
        get: function () {
            return [_val__WEBPACK_IMPORTED_MODULE_0__["Val"].letters(), _val__WEBPACK_IMPORTED_MODULE_0__["Val"].minLength(15)];
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(Book, "dateValidators", {
        get: function () {
            return [_val__WEBPACK_IMPORTED_MODULE_0__["Val"].required()];
        },
        enumerable: true,
        configurable: true
    });
...
var BooksService = /** @class */ (function () {
    ...
    BooksService.prototype.addBook = function (book) {
        ...
        return new rxjs_Observable__WEBPACK_IMPORTED_MODULE_2__["Observable"](function (observer) {
            var bookIndex = _this.books.indexOf(_this.books.find(function (b) { return b.id === book.id; }));
            var counter = _this.books.length;
            counter++;
            _this.books[bookIndex] = book;
...
var Val = /** @class */ (function () {
    ...
    Val.letters = function (errorMessage) {
        if (errorMessage === void 0) { errorMessage = "This field has to be only letters"; }
        return function (formControl) {
            return formControl.value == "[a-zA-Z ]*" ? (_a = {}, _a[Val.key] = errorMessage, _a) : null;
            var _a;
        };
    };
    Val.dateValidation = function (errorMessage) {
        ...
        return function (formControl) {
            return formControl.value == "/^\d{4,}-[01]\d-[0-3]\dT[0-2]\d:[0-5]\d:[0-5]\d\.\d+(?:[+-][0-2]\d:[0-5]\d|Z)$/" ? (_a = {}, _a[Val.key] = errorMessage, _a) : null;
            var _a;
        };
    };
...
module.exports = __webpack_require__(/*! D:\עבודה\new Herolo\project- Mali\my-app\src\main.ts */"./src/main.ts");
